          ...
          <div className='flex flex-col items-center gap-16 lg:flex-row'>
            <div className='relative w-full lg:flex-1'>
              ...
              >
                ...
                />
                <div className='absolute bottom-8 left-8 right-8 rounded-2xl border space-y-1 border-white/20 bg-black/40 p-6 shadow-xl backdrop-blur-md text-center'>
            ...
            <div className='flex w-full flex-col gap-8 lg:flex-1'>
              <div className='flex flex-col gap-4 text-center lg:text-left'>
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className='inline-flex items-center gap-2 self-center rounded-full border px-4 py-1.5 text-sm font-semibold lg:self-start'
                >
                      ...
                      <Card className='relative flex h-full flex-col items-center text-center gap-2 overflow-hidden rounded-card-large border-zinc-100 bg-white p-0 transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:shadow-black/5'>
                        ...
                        <CardContent className='p-10 pt-0'>
                          ...
                          <div className='flex flex-col gap-2'>
                            <h3 className='bg-linear-to-r from-primary to-primary bg-clip-text text-xl font-black tracking-tight italic text-transparent uppercase'>
                              {brand.name}
                            </h3>
