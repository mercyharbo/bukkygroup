...
export const PartnerLogos = () => {
  return (
    <section className='w-full py-16 md:py-24 bg-[#F9F7F5] border-t border-zinc-100'>
      <div className='container mx-auto px-5 lg:px-10 space-y-12'>
        ...
        <div className='flex flex-wrap items-center justify-center gap-12 md:gap-24 opacity-60'>
          {partners.map((partner, idx) => (
            ...
            >
              <div className='flex items-center justify-center h-full text-black font-cinzel font-bold text-lg uppercase tracking-widest'>
                {partner.name}
              </div>
            </motion.div>
          ))}
