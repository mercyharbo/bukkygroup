      ...
      <div className='container mx-auto px-6'>
        <div className='flex flex-col lg:flex-row items-center gap-16 lg:gap-24'>
          ...
          <div className='w-full lg:w-1/2 relative'>
            ...
            >
              <Image
                src='https://images.unsplash.com/photo-1594465919760-441fe5908ab0?q=80&w=1925&auto=format&fit=crop'
          ...
          <div className='w-full lg:w-1/2 space-y-8'>
            ...
            <Button
              asChild
              className='bg-orange-500 text-white hover:bg-black transition-all px-10 h-14 rounded-full font-medium'
            >
