    ...
    <section className='w-full py-24 bg-white'>
      <div className='container mx-auto px-5 lg:px-10 space-y-16'>
        <div className='flex flex-col items-center text-center space-y-4'>
          <h2 className='text-4xl lg:text-6xl font-bold tracking-tight text-black'>
            Ways to <span className='text-foundation-primary'>Give</span>
          </h2>
          <p className='text-gray-600 max-w-2xl text-pretty text-lg'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {ways.map((way, idx) => (
            ...
            >
              <Card className='h-full rounded-card-foundation border-2 border-foundation-primary/10 hover:border-foundation-primary/40 bg-foundation-light/10 transition-all group p-4'>
                <CardContent className='p-8 flex flex-col items-center text-center space-y-6'>
                  <div className='size-20 rounded-full bg-white shadow-premium flex items-center justify-center text-foundation-primary group-hover:scale-110 group-hover:bg-foundation-primary group-hover:text-white transition-all duration-500'>
                    {way.icon}
                  </div>
                  ...
                  <Button
                    size={'lg'}
                    className='w-full bg-foundation-primary text-black transition-all '
                    asChild
                  >
        ...
        <motion.div
          ...
          className='relative w-full rounded-card-foundation bg-foundation-primary p-12 lg:p-20 overflow-hidden'
        >
          <div className='absolute inset-0 opacity-10 pointer-events-none'>
            <div className='absolute top-0 left-0 size-64 bg-foundation-primary rounded-full blur-[100px]' />
            <div className='absolute bottom-0 right-0 size-64 bg-foundation-accent rounded-full blur-[100px]' />
          </div>
          <div className='relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 w-full lg:w-auto'>
              ...
              <Button
                size='xl'
                variant='outline'
                className='text-white hover:bg-white hover:text-black border-white/40'
                asChild
              >
