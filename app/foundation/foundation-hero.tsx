  ...
  return (
    <section className='relative w-full px-5 lg:px-10 py-40 lg:py-48 overflow-hidden'>
      <div className='container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        >
          <div className='inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-gray-300/30 bg-muted/20 w-fit shadow-sm'>
          ...
          <h1 className='text-5xl lg:text-6xl font-bold text-balance leading-tight'>
            A Safe Place. <br />A Listening Ear. A Guiding Light.
          </h1>
          ...
          <div className='flex flex-wrap gap-4 pt-4'>
            <Button
              size='xl'
              className='bg-white text-black font-semibold transition-all hover:bg-white/90 transform hover:scale-105 active:scale-95 '
            >
              Donate Now
            </Button>
            <Button
              size='xl'
              variant='outline'
              className='border-2 border-white/20 text-white font-semibold hover:bg-white/5 hover:text-white transition-all'
              asChild
            >
          ...
          <Card className='absolute -bottom-28 -right-4 sm:-bottom-20 sm:-right-20 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl max-w-[280px] sm:max-w-xs border border-white/50 animate-in fade-in slide-in-from-bottom-10 duration-1000 origin-bottom-right scale-100 sm:scale-105 z-20'>
            <CardContent className='flex flex-col gap-3 sm:gap-4 p-5 sm:p-6'>
              <div className='flex items-center gap-4'>
                <div className='size-10 sm:size-12 rounded-full bg-muted/10 flex items-center justify-center shrink-0'>
                  <HiOutlineHeart className='size-6 sm:size-7 text-black' />
                </div>
                <div>
              ...
              <Button
                size='lg'
                className='w-full bg-black text-white text-sm sm:text-base hover:bg-black/90 transition-all hover:scale-[1.02] active:scale-[0.98]'
              >
                Impact Report
              </Button>
            </CardContent>
