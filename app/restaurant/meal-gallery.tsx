...
const mealShowcase = [
  ...
  { src: '/foods/foodie (5).webp', title: 'Royal Breakfast', category: 'Morning' },
  { src: '/foods/foodie (4).webp', title: 'Goat Meat Special', category: 'Special' },
  { src: '/foods/foodie (1).heic', title: 'Village Native', category: 'Rice' },
  { src: '/foods/foodie (12).webp', title: 'Exotic Drinks', category: 'Beverage' },
  { src: '/foods/foodie (14).webp', title: 'Imperial Combo', category: 'Platter' },
]
      ...
      <div className='container mx-auto px-5 lg:px-10 space-y-16'>
        <div className='flex flex-col md:flex-row md:items-end justify-between gap-8'>
          <div className='space-y-4'>
            <span className='text-xs uppercase tracking-[0.5em] text-primary font-bold'>
              Visual Feast
            </span>
          ...
          <p className='max-w-md text-gray-300 text-sm leading-relaxed font-serif italic'>
